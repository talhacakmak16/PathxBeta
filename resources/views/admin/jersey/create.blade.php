                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header" data-background-color="purple">
                            <h4 class="title">Forma Ekle</h4>
                            <p class="category">Stokta Bulunan Forma Giriniz</p>
                        </div>
                        <div class="card-content">
                            <form enctype="multipart/form-data" action="{{route('admin.jersey.create.post')}}" method="post">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group label-floating is-empty">
                                            <label class="control-label">Forma Adı</label>
                                ...
                                <button type="submit" class="btn btn-primary pull-right">Forma Ekle</button>
